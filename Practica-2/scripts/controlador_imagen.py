...
# 1. Definimos los modelos que se deben ver en blanco y negro
# Agregamos "BINARIO" porque también es de un solo canal
modelos_monocromaticos = ["GRIS", "BINARIO"]

# 2. Carga de una imagen RGB con OpenCV
...
# 3. Carga de imagen en escala de grises con OpenCV
...
# 4. Binarización con umbral dínamico
...
# 5. Binarización con umbral de Otsu
...
# 6. Cambiar modelo de color a HSV
...
# 7. Cambiar modelo de color a CMY
...
def es_CMY(imagen_metadata):
    """
    Nota sobre CMY: No hay forma de saber si una matriz es CMY o RGB solo por sus valores,
